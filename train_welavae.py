...
model = 'tcvae'  # betavae
fig_dir = "blobs/results/double_labels/{}/corner_labels/res{}".format(model,
                                                                      res)
...
for SEED in seeds_0:
    for gamma in gammas:
        for beta in betas:
            ...
            # TRAINING
            try:
                history = welavae.welavae.fit([x_train, angle_shuffled,
                                               dist_shuffled],
                                              None,
                                              epochs=num_epochs,
                ...
                means, log_vars = welavae.encoder.predict([blobs_flat,
                                                          angle_labels,
                                                          dist_labels])
                ...
                quality_welavae(dataset=blobs_flat, mean_vec=means,
                                ...
                                decode_model=welavae.decoder, n_cols=10,
                                image_res=64,
                                a=-3, b=3,
