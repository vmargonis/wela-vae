...
class WeLaBetaVAE(BaseWeLaVAE):
    ...
    def wela_beta_vae_loss(self, config: Dict) -> tf.Tensor:
...
class WeLaTCVAE(BaseWeLaVAE):
    ...
    def wela_tcvae_loss(self, config: Dict) -> tf.Tensor:
        """TCVAE Batch Loss:
...
class WeLaDIPVAE(BaseWeLaVAE):
    ...
    def wela_dip_vae_loss(self, config: Dict) -> tf.Tensor:
        """DIPVAE Batch Loss:
